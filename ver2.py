...
class MyApp(App):
    def build(self):
        ...
        return self.layout
# function to open file chooser popup and show files in the current directory where the app is running
...
# function to handle the selected file in a file chooser popup
